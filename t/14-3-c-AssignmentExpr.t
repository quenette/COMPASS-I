...
(display (=-ae? ae1)) (newline) ; #t
(is-ok  1 "(ae? ae1)"        #t          (ae? ae1))
(is-ok  2 "(=-ae? ae1)"      #t          (=-ae? ae1))
...
(is-ok  3 "a = 5; tval"        5  (tval->val tval1))
(is-ok  4 "a = 5; a"           5  (apply-s (car l1,rho2) (tval->s tval1)))

(define tval2 ((ast->e-ae "t.ext[5].children()[1][1].children()[1][1]") jp1 zeta1 (tval->rho tval1) (tval->s tval1)))
(is-ok  5 "b = a; tval"        5  (tval->val tval2))
(is-ok  6 "b = a; b"           5  (apply-s (car l2,rho3) (tval->s tval2)))

(define tval3 ((ast->e-ae "t.ext[5].children()[1][1].children()[2][1]") jp1 zeta1 (tval->rho tval2) (tval->s tval2)))
(is-ok  7 "c = a = 3; tval"    3  (tval->val tval3))
(is-ok  8 "c = a = 3; c"       3  (apply-s (car l3,rho4) (tval->s tval3)))
(is-ok  9 "c = a = 3; a"       3  (apply-s (car l1,rho2) (tval->s tval3)))

(define tval4 ((ast->e-ae "t.ext[5].children()[1][1].children()[3][1]") jp1 zeta1 (tval->rho tval3) (tval->s tval3)))
(is-ok 10 "d = &a; tval"   100000  (tval->val tval4))
(is-ok 11 "d = &a; d"      100000  (apply-s (car l4,rho5) (tval->s tval4)))

(define tval5 ((ast->e-ae "t.ext[5].children()[1][1].children()[4][1]") jp1 zeta1 (tval->rho tval4) (tval->s tval4)))
(is-ok 12 "*d = 7; tval"        7  (tval->val tval5))
(is-ok 13 "*d = 7; d"      100000  (apply-s (car l4,rho5) (tval->s tval5)))
(is-ok 14 "*d = 7; a"           7  (apply-s (car l1,rho2) (tval->s tval5)))
